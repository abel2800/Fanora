...
class TopupCbeScreen extends ConsumerStatefulWidget {
  const TopupCbeScreen({super.key});

  @override
  ConsumerState<TopupCbeScreen> createState() => _TopupCbeScreenState();
}

class _TopupCbeScreenState extends ConsumerState<TopupCbeScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final result = await ref.read(walletServiceProvider).topupCbe(amount, pin: _pin.text);
